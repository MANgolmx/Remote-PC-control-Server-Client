...
namespace TCP_Client.Activities
{
    ...
    public class DeviceMenuActivity : Activity
    {
    ...
    "Yemen","Yugoslavia","Zambia","Zimbabwe"
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.DevicesPage);
            Toast.MakeText(this, "2", ToastLength.Short).Show();

            items = new List<string>(countries);
            Toast.MakeText(this, "3", ToastLength.Short).Show();

            adapter = new ArrayAdapter<string>(this, Resource.Id.deviceList, items);
            Toast.MakeText(this, "4", ToastLength.Short).Show();

            ListView lw = FindViewById<ListView>(Resource.Id.deviceList);
